function [kM_IDs isC] = checkConsistency(matchedKeys, loc1, loc2, N, K, ths)
...
for i = 1:numMatched
    ...
    % if all of them vote for consistency, hence their values are 1, then
    % the multiplication should be 1 for that neighbor
